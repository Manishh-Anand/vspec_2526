...
# -*- coding: utf-8 -*-
"""
ResearchAgent - Auto-generated agent for MetaFlow
Position: 1
...
class Researchagent:
    """
    Handles: Conducts comprehensive research on the KTM ADV 390 X PLUS in white, gathering detailed information about its specifications, features, pricing, and reviews from various sources.
    """
    ...
    def __init__(self):
        ...
        # Role Definition
        self.role = """Conducts comprehensive research on the KTM ADV 390 X PLUS in white, gathering detailed information about its specifications, features, pricing, and reviews from various sources."""
    ...
    async def _process_task(self, input_data: Any) -> Any:
        """
        Main processing logic for ResearchAgent
        ...
        # Conducts comprehensive research on the KTM ADV 390 X PLUS in white, gathering detailed information about its specifications, features, pricing, and reviews from various sources.

...
export default function RadialOrbitalTimeline({
    ...
    return (
        <div
            className="w-full h-[600px] flex flex-col items-center justify-center bg-black overflow-hidden relative rounded-xl border border-zinc-900"
            ref={containerRef}
                                ...
                                {isExpanded && (
                                    <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-80 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible z-50">
                                        ...
                                        <CardContent className="text-xs text-white/80">
                                            <p className="max-h-40 overflow-y-auto pr-1">{item.content}</p>
